...
<head>
    ...
    <title> Hapiverse | Reset Password</title>
            ...
            <div class="login-container">
                <div class="columns is-vcentered">
                    ...
                    <div class="column is-6">
                        ...
                        <!--Form-->
                        <form action="<?php echo base_url().'index.php/Welcome/newpassword' ?>" method="POST">
                        ...
                        <div class="login-form">
                            ...
                            <div class="buttons">
                                <button class="button is-solid primary-button is-fullwidth raised">Reset</button>
                            </div>
                        </div>
                        </form>
                    </div>
