            ...
            <div id="activity-feed" class="view-wrap true-dom is-hidden">
                <div class="columns">
                    ...
                    <div class="column is-8">
                      ...
                      <form method="POST" action="<?php echo base_url("Group/addPost") ?>" enctype="multipart/form-data"> 
                       <div id="compose-card" class="card is-new-content">
                            ...
                            <div class="tabs-wrapper">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div id="basic-options" class="compose-options">
                                        ...
                                        <input type="hidden" name="groupId" value="<?php echo $groupDetail->data->groupId; ?>">
                                        <!-- Mood action -->
                        ...
                        <?php } } else { ?>
                            <h4 class="alert alert-warning"><?php echo $message['message']; ?></h4>
                            <?php } ?>
                        </div>
                        <!-- /POST #4 -->
                        <!-- Load more posts -->
            ...
            <div class="card">
                ...
                <div class="card-body no-padding">
                    <div class="story-block">
                        <img src="<?php echo base_url($groupDetail->data->groupImageUrl) ?>">
                    </div>
                    <div class="story-block">

                        <div class="story-meta">
                            <h1 style="font-size: 18px;"><strong><?php echo $groupDetail->data->groupName ?></strong></h1>
                            <p style="font-size: 13px;display: inline;"><?php echo $groupDetail->data->groupPrivacy ?> Group <br> <span
                                    style="display: inline;"><?php echo  $groupDetail->data->totalMemeber  ?> members</span></p>
                        </div>
                    </div>
                    ...
                    <div class="story-block">
                        ...
                        <div class="story-meta">
                            <button class="btn"><i class="fa fa-users"></i>
                                <strong>Joined</strong></button>
                            <button class="btn"><strong>Invite</strong></button>
                        </div>
                    </div>
