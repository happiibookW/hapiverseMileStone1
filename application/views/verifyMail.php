...
<head>
    ...
    <title> Hapiverse | Send Email</title>
            ...
            <div class="login-container">
                <div class="columns is-vcentered">
                    ...
                    <div class="column is-6">
                        ...
                        <h3 class="form-subtitle">An 4 digit code has been sent to your email</h3>

                        <!--Form-->
                        <form action="<?php echo base_url().'index.php/Welcome/chooseplan' ?>" method="POST">
                        ...
                        <div class="login-form">
                            ...
                            <div class="field">
                                    <label>Email</label>
                                    <div class="control">
                                        <input type="email" class="input" placeholder="Enter Verification Code" name="email" required>
                                    </div>
                                </div>
                                <div class="field">
                                    <label>OTP Code</label>
                                    <div class="control">
                                        <input type="text" class="input" placeholder="Enter Verification Code" name="verificationCode" required>
                                    </div>
                                </div>
