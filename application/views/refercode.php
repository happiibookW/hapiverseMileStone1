...
<head>
    ...
    <title> Hapiverse | Reference Code</title>
            ...
            <div class="login-container">
                <div class="columns is-vcentered">
                    ...
                    <div class="column is-6">
                        ...
                        <h3 class="form-subtitle">Enter Your Reference Code</h3>
                        ...
                        <div class="login-form">
                            ...
                            <?php } ?>
                                <div class="field">
                                    ...
                                    <div class="control">
                                        <input type="text" class="input" placeholder="Enter Reference Code" name="email" required>
                                    </div>
                                </div>
