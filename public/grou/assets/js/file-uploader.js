      ...
      return this.each(function (i) {
        ...
        function label() {
          ...
          var labelhtml =
            '<label for="' +
            customInput +
            '" class="aks-file-upload-label custom-label custom-label-s2 d-flex flex-column mb-2"><i class="fas fa-plus fs-3 mb-2"></i><span>' +
            settings.label +
            "</span></label>";
          ...
          function allOkey() {
            ...
            function deleteButton() {
              var deleteButton =
                ...
                fileName +
                '"><svg width="26" height="26" viewBox="0 0 26 26" xmlns="http://www.w3.org/2000/svg"><path d="M11.586 13l-2.293 2.293a1 1 0 0 0 1.414 1.414L13 14.414l2.293 2.293a1 1 0 0 0 1.414-1.414L14.414 13l2.293-2.293a1 1 0 0 0-1.414-1.414L13 11.586l-2.293-2.293a1 1 0 0 0-1.414 1.414L11.586 13z" fill="#fff" fill-rule="nonzero"></path></svg></div>';
            ...
            if (!file.type.match("image.*")) {
              ...
              reader.onload = function (e) {
                ...
                $('[data-file="' + fileName + '"]').animate({ height: 80 }, 200);
                $('[data-file="' + fileName + '"]').fadeIn(650);
              };
