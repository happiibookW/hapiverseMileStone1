...
$(window).on("load", (function () {
    var a, e, o, r, t, s, l, i, d, n, h, w = "#e9ecef",
    ...
    else if (f.length > 0) new PerfectScrollbar(f[0], {
        wheelPropagation: !1
    });
    a = {
        chart: {
