            ...
            <div class="content-body">
                <div class="auth-wrapper auth-v2">
                    <div class="auth-inner row m-0">
                        ...
                        <!-- /Brand logo-->
                        <!-- Left Text-->
                        <div class="d-none d-lg-flex col-lg-8 align-items-center p-5 bg-white">
                            <div class="w-100 d-lg-flex align-items-center justify-content-center px-5">
                                <img style="width: 100%; max-width: 700px;" src="{{asset('libraries/assets/img/illustrations/characters/login-screen.svg')}}" alt="Login V2" />
                            </div>
                        </div>
                        <!-- /Left Text-->
                        <!-- Login-->
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5 card">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto d-flex justify-content-center flex-column">
                                <h2 class="card-title font-weight-bold mb-1">Welcome to Hapiverse!</h2>
